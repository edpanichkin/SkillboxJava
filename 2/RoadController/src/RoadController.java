...
{
    // ниже блок, где задаются переменные параметров для дальнейшей проверки по генерируемым машинам.
    ...
    public static void main(String[] args)
    {
        for(int i = 0; i < 10; i++)
        {
            ...
            for(String criminalNumber : Police.getCriminalNumbers())
            {
             ...
             //   но должно выше искать и номера всеъ машин, не разделяя на специальные.
            if(car.isSpecial()) {
                openWay();
                continue;
            }
